                ...
                <Document>
                    <Page style={styles.body} size="A4" fixed >
                        ...
                        <View style={styles.containerIntroItems}>
                            ...
                            <View style={styles.introItems}>
                                <View style={styles.introViewKeyValue}>
                                    ...
                                    <Text style={styles.value}>{pdfData && pdfData["CM-COTIZACIÓN No"] && pdfData["CM-COTIZACIÓN No"]}</Text>
                                </View>
                                <View style={styles.introViewKeyValue}>
                        ...
                        <View style={styles.viewKeyValueElaborado} >
                            ...
                            <Text style={styles.valueElaboradorLine}>{pdfData && pdfData[`CM-ELABORADOR`] && pdfData[`CM-ELABORADOR`]}</Text>
                        </View>
